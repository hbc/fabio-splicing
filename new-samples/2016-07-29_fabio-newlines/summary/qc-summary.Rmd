...
fcplot = data.frame(additive=e7107[sig,]$log2FoldChange + bort[sig,]$log2FoldChange,
                    both=be[sig,]$log2FoldChange, amplified=ifelse(amplified, "amplified", ifelse(dampened, "dampened", "neither")))
ggplot(fcplot, aes(additive, both, color=amplified)) + geom_point() +
