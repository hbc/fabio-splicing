...
Here we write out the table of all of the differentially expressed genes for
...
# Pathway analysis
These functions to do pathway analysis on DESeq2 results are generated
automatically now. Leaving it in just in case.
...
# Output tables
[Bort vs ctrl](Bort vs Ctrl.tsv)
[BE vs ctrl](BE vs Ctrl.tsv)
[E7107 vs ctrl](E7107 vs Ctrl.tsv)

[Control vs bort](control-vs-bort-sleuth.csv)
[Control vs be](control-vs-be-sleuth.csv)
[Control vs e7017](control-vs-e7017-sleuth.csv)
